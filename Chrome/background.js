var buttonClicked = function() {
  // var version = localStorage["jquery_version"] || "2.1.1";
    ...
    //script.push('if (typeOf(contextCommentPanelOpen) == 'function'){')
    ...
    //script.push('script.onload = function(){window.contextCommentPanelOpen();};');
    //script.push('script.onload = function(){console.log(window);};');

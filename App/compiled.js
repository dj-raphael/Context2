  ...
  '$rootScope', '$window', '$timeout', function ($rootScope, $window, $timeout) {
      return {
          link: function (scope, elem, attrs) {
              ...
              $window = angular.element($('.CI_scrollable')[1]); /*<- Hack! */
              scrollDistance = 0;
...
define('frame/app', ['angular', 'ui-bootstrap', 'ui-tinymce', 'infinite-scroll'], function (ng) {
    var app = ng.module('app', ['ui.bootstrap', 'ui.tinymce', 'infinite-scroll']);
	return app;
});


define('frame/tabs', ['frame/app', 'services/config', 'services/auth', 'services/faq', 'services/wiki', 'frame/wiki-controller', 'frame/faq-controller', 'frame/discussion-controller', 'frame/profile-toolbar-controller', 'frame/plus-toolbar-controller', 'frame/options-controller', 'frame/banner-controller', "frame/authorization-controller"],
...
define("directives/social-login-buttons", ["frame/app"], function (app) {
    app.directive("socialLoginButtons", function () {
        return {
            restrict: "E",

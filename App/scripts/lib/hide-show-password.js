...
(function($) {
    ...
    var style = $('<style>'
    +'.view-password {display: block;width: 32px;height: 32px;cursor: pointer;position: absolute; right: 0; top: 0; margin-left: -32px; background-repeat: no-repeat}'
    ...
    function ShowHidePassword(el, op) {
        ...
        if (!this.options.size) {
            this.options.size = this.$element.height();
        }
